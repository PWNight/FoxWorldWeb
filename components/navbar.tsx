...
export function Navbar() {
  return (
    <nav className="sm:w-[94vw] w-full mx-auto border-b max-h-16 sticky top-0 z-50 lg:px-14 px-1 backdrop-filter backdrop-blur-xl bg-opacity-5 flex items-center">

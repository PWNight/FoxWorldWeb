                    ...
                    <div className="flex flex-row justify-between items-center gap-4 md:gap-6">
                        <div className="flex items-center gap-3">
                            <Image
                                ...
                                height={30}
                                quality={100}
                                className="flex-shrink-0 transition-transform hover:scale-105 sm:h-[35px] sm:w-[35px]"
                            />
                            <div className="space-y-0.5">
                                <p className="font-medium text-sm sm:text-base">FoxWorld © 2025</p>
                                <p className="text-[10px] opacity-75 sm:text-xs">v1.0.0-beta5 PRE-1 (12.03.25)</p>
                            </div>
                        </div>
                        <FooterButtons />
                    </div>
                        ...
                        <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
                            <Link
                                ...
                                className={buttonVariants({
                                    ...
                                    size: "sm",
                                    className:
                                        "!px-0 py-1 text-xs hover:text-accent-foreground transition-colors duration-200 sm:text-sm",
                                })}
                            >
                                Условия пользования
                            </Link>
...
export function FooterButtons() {
    return (
        <div className="flex items-center justify-center gap-2">
            ...
            >
                <LifeBuoy className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
            </Link>
        </div>
    );
}
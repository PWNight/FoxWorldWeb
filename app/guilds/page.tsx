...
export default function Guilds() {
    ...
    if (guilds.length === 0) {
        ...
        return (
            <div className="flex flex-col px-4 sm:w-[90%] w-full mx-auto container">
                <div className="flex mt-4 flex-col gap-4 select-none">
                    <h1 className="text-3xl font-bold">Гильдии</h1>
                    <input
                        className="p-3 border-2 border-solid w-60 rounded-lg outline-none focus:ring-2 focus:ring-blue-500"
                        type="text"
